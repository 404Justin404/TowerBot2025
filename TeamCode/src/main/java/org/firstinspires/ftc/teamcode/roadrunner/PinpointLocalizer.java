...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1053.2964026273123; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 138.69126512996786; // x position of the perpendicular encoder (in tick units)
    }
