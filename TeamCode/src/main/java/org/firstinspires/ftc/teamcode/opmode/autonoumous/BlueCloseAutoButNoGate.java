...
@Configurable
@Autonomous(name="Blue Close Auto No Gate", group="Auto")
public class BlueCloseAutoButNoGate extends LinearOpMode {
...
//                .setBrakingStart(0.8)
        ...
        Stack3Shoot = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(-180), Math.toRadians(-51))
                .build();
...
//                .setLinearHeadingInterpolation(Math.toRadians(-51), Math.toRadians(150),0.7)
                .setLinearHeadingInterpolation(Math.toRadians(-51), Math.toRadians(155))
        ...
        GateOut = follower.pathBuilder()
                ...
                .setVelocityConstraint(50)
                .setLinearHeadingInterpolation(Math.toRadians(155), Math.toRadians(-51))
                .build();
